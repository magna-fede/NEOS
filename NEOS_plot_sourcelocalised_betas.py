...
for sbj_id in sbj_ids:
    ...
    for cond in stc_conditions:
        evo_fname = f"/imaging/hauk/users/fm02/MEG_NEOS/data/AVE/{sbj_id}_evoked-betas_forsource.fif"
...
for cond in stc_conditions:
    ...
    plt.title(cond)
    plt.savefig(f"/imaging/hauk/users/fm02/MEG_NEOS/data/plots/betas_insource/{cond}_acrossROIs.png")
...
for cond in stc_conditions:
    for roi in rois_lab:
        ...
        plt.title(roi)
        plt.savefig(f"/imaging/hauk/users/fm02/MEG_NEOS/data/plots/betas_insource/{cond}_in_{roi}_acrossparticipants.png")
